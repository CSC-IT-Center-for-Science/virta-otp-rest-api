...
public class OpintopistePvmYORepositoryTest extends BaseRepositoryTest<OpintopistePvmYO> {
    ...
    public void testStreamAll() throws Exception {
        assertStreamResults(Arrays.asList(
                createEntity(1L, 1, 1, "db", 1, 1, 1, "koodi", "kuvaus", 1, "luoja", new Date(), "oppilaitostunnus", 1, new Date(), 1, 1, 2016),
                createEntity(2L, 2, 2, "db2", 2, 2, 2, "koodi2", "kuvaus2", 2, "luoja2", new Date(), "oppilaitostunnus2", 2, new Date(), 2, 2, 2016)), repository.streamAll());
    }

    private OpintopistePvmYO createEntity(long id, int erillinenOpintoOpettaja, int avoinKK, String db, int erillinenOpintoOikeus, int kansainvVaihto, int kkYhteistyo, String koodi, String kuvaus, int lukumaara, String luoja, Date luontipaivamaara, String oppilaitostunnus, int perustutkOpiskelijat, Date suorituspaiva, int ulkomailtaHyvLuet, int vieraskSuoritukset, int vuosi) {
