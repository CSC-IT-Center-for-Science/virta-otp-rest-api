...
public class AMKAvoimenOpintopisteetJarjRepositoryTest extends BaseRepositoryTest<fi.csc.virta.opintotieto.entity.AMKAvoimenOpintopisteetJarj> {
    ...
    private AMKAvoimenOpintopisteetJarj createEntity(long id, String db, String koodi, String kuvaus, String luoja, Date luontipaivamaara, int opintopisteet, String oppilaitostyyppi, String paivittaja, Date paivityspaivamaara, int vuosi) {
        AMKAvoimenOpintopisteetJarj entity = new AMKAvoimenOpintopisteetJarj();
        entity.setId(id);
        entity.setDb(db);
