...
public class TavoiteajassasuoritettututkintoRepositoryTest extends BaseRepositoryTest<Tavoiteajassasuoritettututkinto> {
    ...
    public void testStreamAll() throws Exception {       
          assertStreamResults(Arrays.asList(						
                        createEntity(  1L, new Date(), 2015, 31, 3, "ARCADA", 1, "6121-18626", "6121", "18626", "02535",615,2,1,4, new Date(), "721601", 2017, 60, 1.7 ),
                        createEntity(  2L, new Date(), 2015, 31, 3, "ARCADA", 1, "7121-28626", "7121", "28626", "02535",615,2,1,4, new Date(), "631101", 2017, 210, 2.0 ),
						createEntity(  3L, new Date(), 2015, 31, 3, "ARCADA", 1, "8121-38626", "8121", "38626", "02535",615,2,1,4, new Date(), "671112", 2017, 210, 3.0 )
						),						
